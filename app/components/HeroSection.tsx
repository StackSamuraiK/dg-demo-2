...
export default function HeroSection() {
  ...
  return (
    <header
      ...
      {/* Fixed vertical decorative lines */}
      <div className="fixed inset-0 pointer-events-none z-0 flex justify-between px-6 md:px-10 max-w-7xl mx-auto left-1/2 -translate-x-1/2 w-full">
        <div className="w-px h-full bg-[#1E3A5F]/60 hidden md:block" />
        <div className="w-px h-full bg-[#1E3A5F]/40 hidden lg:block" />
        <div className="w-px h-full bg-[#1E3A5F]/60 hidden md:block" />
      </div>
      {/* Rotating Badge */}
      ...
      <div className="lg:col-span-5 flex flex-col justify-center relative z-10 order-2 lg:order-1 pt-8 lg:pt-0">
        <div className="mb-10">
          ...
          <h1
            className="font-serif text-5xl md:text-6xl lg:text-7xl font-light leading-[0.95] tracking-tight text-white mb-6"
            style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
            
            Cross-Border
            <br />
            <span className="italic text-white/60 font-light">Structuring</span>
            <br />
            &amp; Trade
            <br />
            Facilitation
          ...
          <p className="text-sm text-white/60 leading-relaxed border-l border-[#D4AF37]/40 pl-5 mb-8 max-w-sm font-light">
            We redesign how your business operates across borders — not just
        ...
        {/* Stats Row */}
        <div className="grid grid-cols-3 gap-4 pt-8 border-t border-[#1E3A5F]">
          {[
          ...
          <div key={stat?.label} className="text-center">
              <div
              className="text-2xl font-serif text-[#D4AF37] mb-1"
              style={{ fontFamily: 'Playfair Display, Georgia, serif' }}>
      ...
      <div className="lg:col-span-7 h-[55vh] lg:h-[88vh] relative order-1 lg:order-2 z-10">
        <div className="absolute inset-0 arch-container overflow-hidden shadow-2xl border border-[#1E3A5F]">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-[#0B1F3A]/40 via-transparent to-transparent" />
          ...
          <svg
            ...
            <line x1="350" y1="100" x2="350" y2="700" stroke="#D4AF37" strokeWidth="0.5" />
            <line x1="50" y1="400" x2="650" y2="400" stroke="#D4AF37" strokeWidth="0.5" />
            ...
            <circle cx="50" cy="400" r="3" fill="#D4AF37" />
          </svg>
